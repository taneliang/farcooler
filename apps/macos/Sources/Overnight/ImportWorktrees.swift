...
/// A worktree on disk that Overnight does not know about yet.
...
/// Bring worktrees you already have into Overnight.
///
/// The onboarding path, and the reason it matters: Overnight only ever knew
