...
final class ServiceRegistration: ObservableObject {
    ...
    private let plistName = "com.overnight.daemon.plist"
    ...
    func refresh() {
        ...
        guard Bundle.main.bundleURL.pathExtension == "app" else {
            state = .unavailable("Run Overnight from the app bundle to enable this.")
            return
        }
        ...
        @unknown default:
            state = .unavailable("The system reported a status Overnight does not recognise.")
        }
    }
    ...
    private func readable(_ error: Error) -> String {
        ...
        case 2:
            return "The daemon is already registered by another copy of Overnight."
        default:
...
///
///     OVERNIGHT_SERVICE_PROBE=status ./Overnight.app/Contents/MacOS/Overnight
///
